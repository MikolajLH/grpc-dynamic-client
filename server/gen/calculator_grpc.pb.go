...
type CalculatorClient interface {
	Add(ctx context.Context, in *BinaryOpArguments, opts ...grpc.CallOption) (*BinaryOpResult, error)
}
...
func (c *calculatorClient) Add(ctx context.Context, in *BinaryOpArguments, opts ...grpc.CallOption) (*BinaryOpResult, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(BinaryOpResult)
...
type CalculatorServer interface {
	Add(context.Context, *BinaryOpArguments) (*BinaryOpResult, error)
...
func (UnimplementedCalculatorServer) Add(context.Context, *BinaryOpArguments) (*BinaryOpResult, error) {
...
func _Calculator_Add_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CalculatorServer).Add(ctx, req.(*BinaryOpArguments))
	}
